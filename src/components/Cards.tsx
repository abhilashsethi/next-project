				...
				{cardArr.map((item, index) => {
					return (
						<motion.div
							...
							className="px-2 rounded-lg flex flex-col justify-center items-center border-2 w-full md:w-[30%] h-52 border-[#ffb8cb] hover:bg-[#ffb8cb] transition duration-500 ease-out gap-4"
						>
