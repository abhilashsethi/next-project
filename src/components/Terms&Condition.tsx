...
const TermsAndCondition = () => {
	return (
		<div>
			<h1>Terms and Conditions for tSmart</h1>

			<h2>Introduction</h2>

			<p>
				These Website Standard Terms and Conditions written on this webpage
				shall manage your use of our website, tSmart accessible at
				https://www.tsmartuk.co.uk/.
			</p>
			...
			<p>
				Other than the content you own, under these Terms, tSmart and/or its
			...
			<p>
				...
				and tSmart may further restrict access by you to any areas of this
			...
			<p>
				...
				display on this Website. By displaying Your Content, you grant tSmart a
			...
			<p>
				...
				rights. tSmart reserves the right to remove any of Your Content from
			...
			<p>
				This Website is provided "as is," with all faults, and tSmart express no
			...
			<p>
				In no event shall tSmart, nor any of its officers, directors and
				...
				under contract.  tSmart, including its officers, directors and employees
			...
			<p>
				You hereby indemnify to the fullest extent tSmart from and against any
			...
			<p>
				tSmart is permitted to revise these Terms at any time as it sees fit,
			...
			<p>
				The tSmart is allowed to assign, transfer, and subcontract its rights
			...
			<p>
				These Terms constitute the entire agreement between tSmart and you in
			...
			<p>
				...
				laws of the State of gb, and you submit to the non-exclusive
				jurisdiction of the state and federal courts located in gb for the
