...
const PrivacyPolicy = () => {
	return (
		<div>
			<h1>Privacy Policy for tSmart</h1>

			<p>
				At tSmart, accessible from https://www.tsmartuk.co.uk/, one of our main
				priorities is the privacy of our visitors. This Privacy Policy document
				contains types of information that is collected and recorded by tSmart
				and how we use it.
			</p>
			...
			<p>
				tSmart follows a standard procedure of using log files. These files log
			...
			<p>
				Like any other website, tSmart uses 'cookies'. These cookies are used to
			...
			<p>
				...
				advertising partners of tSmart.
			</p>

			<p>
				Third-party ad servers or ad networks uses technologies like cookies,
				JavaScript, or Web Beacons that are used in their respective
				advertisements and links that appear on tSmart, which are sent directly
			...
			<p>
				Note that tSmart has no access to or control over these cookies that are
			...
			<p>
				tSmart's Privacy Policy does not apply to other advertisers or websites.
			...
			<p>
				tSmart does not knowingly collect any Personal Identifiable Information
			...
			<p>
				...
				shared and/or collect in tSmart. This policy is not applicable to any
